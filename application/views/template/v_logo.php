...
<div id="page-wrapper" style="margin: 0">
    <div class="row">
        <div class="col-md-4 col-md-offset-4" style="margin-top: 20px; margin-bottom: 20px; text-align: center;">
            <a href="<?php echo base_url() ?>" class="logo"><img src="<?php echo base_url('static/img/logo.png') ?>" width="100%"></a>
        </div>
