...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">Form Inventarisasi Data Pokok Anggota Pemuda Persis Cabang Banjaran <a href="<?php echo base_url('riwayat/tambah/'.$anggota_id) ?>" class="btn btn-primary" style="float:right">+ Tambah</a> <a href="<?php echo base_url() ?>" class="btn btn-primary" style="float:right;margin-right: 5px">&laquo; Selesai</a></h2>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
