...
class Formulir extends CI_Controller {
	...
	{
		$daftar_anggota = $this->m_formulir->daftar_anggota()->result();

		foreach($daftar_anggota as $list){
	        ...
	        $qrcode = $list->anggota_id.'.png'; //buat name dari qr code sesuai dengan id
	        $alasan = NULL;
	 
	        $params['data'] = $list->anggota_id; //data yang akan di jadikan QR CODE
