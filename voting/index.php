...
<head>
  ...
  <title>Musyawarah Cabang IX PC Persis Banjaran</title>
  <!-- Bootstrap 5 CSS -->
  ...
  <div class="container mt-3">
    <div class="row mb-4" style="border-bottom: 2px solid #ddd;">
        <div class="col-md-6 mb-3" style="text-align: center;">
            <a href="index.php" class="logo"><img src="logo.png" width="70%"></a>
        </div>
        <div class="col-md-6">
    ...
    <div class="mb-3" style="display: flex; gap: 20px; justify-content: center; align-items: center;">
      ...
      <input style="display: none" readonly type="text" id="candidateImage" class="form-control" placeholder="URL Foto Kandidat">
...
<script>
$( function() {
    var anggota = 'data_anggota.json';

    $( "#candidateName" ).autocomplete({
      minLength: 0,
      // source: 'data_anggota.json',
      source: function (request, response) {
        $.ajax({
          url: "data_anggota.json", // Path to your JSON file
          dataType: "json",
      ...
      select: function( event, ui ) {
        $( "#candidateName" ).val( ui.item.label );
        $( "#candidateImage" ).val( ui.item.value );
